...
a = Analysis(['Video-Graph-Player.py'],
             ...
             datas=[('D:\\MTEC Project\\Coding\\Video-Graph\\asset\\autoButton.png','asset'),
                ...
                ('D:\\MTEC Project\\Coding\\Video-Graph\\asset\\Logo.ico','asset'),
...
exe = EXE(pyz,
          ...
          name='Video-Graph-Player(Falling)',
          debug=False,
          bootloader_ignore_signals=False,
          strip=False,
          upx=True,
          console=False, icon='D:\\MTEC Project\\Coding\\Video-Graph\\asset\\Logo.ico')
coll = COLLECT(exe,
               a.binaries,
               a.zipfiles,
               a.datas,
