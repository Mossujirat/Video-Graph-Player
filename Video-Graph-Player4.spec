...
a = Analysis(['Video-Graph-Player4.py'],
             ...
             datas=[('D:\\MTEC Project\\Coding\\Video-Graph\\asset\\autoButton.png','asset'),
                ...
                ('D:\\MTEC Project\\Coding\\Video-Graph\\asset\\Logo4.ico','asset'),
...
exe = EXE(pyz,
          ...
          name='Activity-Graph-Analysis',
          debug=False,
          bootloader_ignore_signals=False,
          strip=False,
          upx=True,
          console=False, icon='D:\\MTEC Project\\Coding\\Video-Graph\\asset\\Logo4.ico')
coll = COLLECT(exe,
               a.binaries,
               a.zipfiles,
               a.datas,
